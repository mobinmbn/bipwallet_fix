...
class TestPaymentChannelServer(PaymentChannelServerBase):
    ...
    def open(self, deposit_tx, redeem_script):
        ...
        assert deposit_tx.outputs[
                   output_index].script.get_hash160() == redeem_script.hash160(), "Invalid deposit tx output script P2SH address."  # nopep8
    ...
    def pay(self, deposit_txid, payment_tx):
        ...
        if channel['payment_tx']:
            ...
            assert payment_tx.outputs[output_index].value > channel['payment_tx'].outputs[
                output_index].value, "Invalid payment tx output value."  # nopep8
